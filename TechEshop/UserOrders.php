<?php
    ...
    $query= mysqli_query($connection,"SELECT * FROM order_items WHERE user_id= '$userid' ORDER BY datetime DESC") or die("Error: " . mysqli_error($connection));
    ...
    { 
        echo "You don't have ordered anything yet!"; 
    }    
    ?>
        <tr>
